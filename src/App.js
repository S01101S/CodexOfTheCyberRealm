...
const Header = ({ onStatsClick, onShopClick, onInventoryClick, playerProfile }) => {
...
function App() {
  ...
  return (
    <div className="bg-custom-bg min-h-screen font-gowun-dodum text-white overflow-x-hidden">
      ...
      <Header onStatsClick={() => setStatsScreenVisible(true)} onShopClick={() => setShopModalVisisble(true)}  onInventoryClick={() => setInventoryVisible(true)} playerProfile={playerProfile} />
      <CharacterStatus 
